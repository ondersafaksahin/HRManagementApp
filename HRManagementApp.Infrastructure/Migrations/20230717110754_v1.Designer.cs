            ...
            modelBuilder.Entity("HRManagementApp.Domain.Entities.Concrete.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("67af1fe6-df9c-4791-a6fd-1b5f48ba31ac"),
                            AppUserID = new Guid("0031c609-4d45-4c50-bbee-278e9dd5ed73"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 7, 17, 14, 7, 53, 871, DateTimeKind.Local).AddTicks(6081),
            ...
            modelBuilder.Entity("HRManagementApp.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 7, 17, 14, 7, 53, 820, DateTimeKind.Local).AddTicks(3573),
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = new Guid("d7620d59-f094-4ded-b04a-facee2041317"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 7, 17, 14, 7, 53, 820, DateTimeKind.Local).AddTicks(3608),
                            Name = "Manager",
                        ...
                        new
                        {
                            Id = new Guid("d8ffe018-f496-4c2d-8082-e2436f22ba46"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 7, 17, 14, 7, 53, 820, DateTimeKind.Local).AddTicks(3610),
                            Name = "Employee",
            ...
            modelBuilder.Entity("HRManagementApp.Domain.Entities.Concrete.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cf57eccd-099f-4bb5-9451-4275a6d75b2c",
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 7, 17, 14, 7, 53, 820, DateTimeKind.Local).AddTicks(3688),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJecKmWXX+75uMhfSFChStOUNfbnOKXcrZ35vva/Ku0FlNv36u/Fq9KVW5Cn4cQ9BA==",
            ...
            modelBuilder.Entity("HRManagementApp.Domain.Entities.Concrete.Package", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 10m,
                            ReleaseDate = new DateTime(2023, 7, 17, 14, 7, 53, 871, DateTimeKind.Local).AddTicks(6402),
                            Status = 0
                        },
                        new
                        {
                            ...
                            Price = 20m,
                            ReleaseDate = new DateTime(2023, 7, 17, 14, 7, 53, 871, DateTimeKind.Local).AddTicks(6404),
                            Status = 0
                        },
                        new
                        {
                            ...
                            PackageName = "Premium",
                            Price = 30m,
                            ReleaseDate = new DateTime(2023, 7, 17, 14, 7, 53, 871, DateTimeKind.Local).AddTicks(6406),
                            Status = 0
                        });
                });
